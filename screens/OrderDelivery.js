...
const OrderDelivery = ({ route, navigation }) => {
    ...
    useEffect(() => {
        ...
        let street = currentLocation.streenName;
    ...
    function calculateAngle(coordinates) {
        ...
        let endLat = coordinates[0]["latitude"];
        let endLng = coordinates[0]["longitude"];
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <View style={{ flex: 1 }}>
                        <Text style={{ ...FONTS.body3 }}>{streenName}</Text>
                    </View>
